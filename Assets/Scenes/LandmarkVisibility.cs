...
public class LandmarkVisibility : MonoBehaviour
{
    ...
    public static Camera visibilityCamera;
    Camera mainCamera;
    ...
    void Update()
    {
        ...
        {
            computeLandmarkVisibility();
        }
    }

    public static void computeLandmarkVisibility()
    {
    ...
    private static bool IsInView(GameObject origin, GameObject building, Camera cam)
    {
